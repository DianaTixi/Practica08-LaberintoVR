...
public class Door : MonoBehaviour {
    ...
    void Start () {
        ...
        audioSource = GetComponent<AudioSource>();
        leftDoorStartRotation  = Quaternion.Euler(-90.0f, 30f, -90.037f);
        leftDoorEndRotation = leftDoorStartRotation * Quaternion.Euler(0f, 0f, 75f);
    ...
    void Update () {
        ...
        if(opening == true)
        {
            leftDoor.transform.rotation = Quaternion.Slerp(leftDoorStartRotation, leftDoorEndRotation, (timer / rotacionTiempo));
            rightDoor.transform.rotation = Quaternion.Slerp(rightDoorStartRotation, rightDoorEndRotation, (timer / rotacionTiempo));
